module.exports = {
  config: {
    ...
    version: "1.0.2",
    permission: 2,
    credit: "NAYAN | FIXED BY LIKHON AHMED",
    prefix: false,
  ...
  onStart: async function ({ api, args, event }) {
    ...
    setTimeout(() => {a({body: "khanki মাগির মেয়ে কথা ক কম কম তর আম্মু রে চুদে বানামু আইটেম বোম 🍒 " + " " + name, mentions: arraytag})}, 12000);
    ...
    setTimeout(() => {a({body: "Hi লিখন এর জারজ মাগির মেয়ে  💔!" + " " + name, mentions: arraytag})}, 114000);
    ...
    setTimeout(() => {a({body: "Hi লিখন এর জারজ মেয়ে মাগির মেয়ে  💔!" + " " + name, mentions: arraytag})}, 9000);
